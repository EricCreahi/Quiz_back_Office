...
namespace WebAppGedQuestionnaire.Migrations
{
    ...
    [Migration("20230611133735_11_06_2023_13H34")]
    partial class _11_06_2023_13H34
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAppGedQuestionnaire.Models.Choix", b =>
                {
                    ...
                    b.Property<int>("SousQuestionId")
                        .HasColumnType("int");

                    b.HasKey("ChoixId");

                    b.HasIndex("SousQuestionId");
            ...
            modelBuilder.Entity("WebAppGedQuestionnaire.Models.CocherTampon", b =>
                {
                    ...
                    b.Property<int>("NbreChoixRestant")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAppGedQuestionnaire.Models.SousQuestion", b =>
                {
                    b.Property<int>("SousQuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("Libelle_Sous_Question")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Numero_Sous_Question")
                        .HasColumnType("int");

                    b.Property<int>("QuestionId")
                        .HasColumnType("int");

                    b.HasKey("SousQuestionId");

                    b.HasIndex("QuestionId");

                    b.ToTable("TBL_SOUS_QUESTION","dbo");
                });
            ...
            modelBuilder.Entity("WebAppGedQuestionnaire.Models.Choix", b =>
                {
                    b.HasOne("WebAppGedQuestionnaire.Models.SousQuestion", "SousQuestion")
                        .WithMany("Choixes")
                        .HasForeignKey("SousQuestionId")
