const http = "http://localhost:4001/Home/";
                        ...
                        if (nbre > 0) {
                                ...
                                var nbre_4 = response_4.data.length;                                   
                                    ...
                                    if (nbre_4 > 0) {                                    
                                        ...
                                        data_retour = retourne_numero_page(response_4.data[response_4.data.length - 1].nbreChoixRestant, response_4.data[response_4.data.length - 1].page,response_4.data[response_4.data.length - 1].questionId);
...
function retourne_numero_page(_nbre, _page, _question) {
    ...
    $.ajax({
        ...
        'success': function (response) {
          ...
          /*  if (_nbre > 0 && _question > 0 ) {
                data = response.data.find(({ page }) => _question == _question );
                return;
            } */
